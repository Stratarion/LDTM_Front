...
import SportFeatures from '@/features/sport/sport-details/ui/legacy/SportFeatures'
...
export default function SportPage() {
  ...
  const handleBack = () => {
    ...
    const savedFilters = localStorage.getItem('developmentFilters')
    
    if (savedFilters) {
      // Если есть сохраненные фильтры, используем их
      router.replace(`/development${savedFilters}`)
    } else {
